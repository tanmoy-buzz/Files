...
CDR_DOWNLOAD_COl = {
    'campaign_name': 'callcenter_calldetail.campaign_name as campaign_name',
    'user': 'usr.username as user',
    'full_name': "CONCAT(usr.first_name, ' ' ,usr.last_name) as full_name",
    'supervisor_name': 'supr.username as supervisor_name',
    'phonebook': 'callcenter_calldetail.phonebook as phonebook',
    ...
    'lan': 'callcenter_calldetail.uniqueid as lan',
    'session_uuid': 'callcenter_calldetail.session_uuid as session_uuid',
    'init_time': "date_trunc('second', COALESCE(callcenter_diallereventlog.init_time, callcenter_calldetail.init_time) at time zone 'Asia/Kolkata') as init_time",
    'ring_time': "date_trunc('second', COALESCE(callcenter_diallereventlog.ring_time, callcenter_calldetail.ring_time) at time zone 'Asia/Kolkata') as ring_time",
    'connect_time': "date_trunc('second', COALESCE(callcenter_diallereventlog.connect_time, callcenter_calldetail.connect_time) at time zone 'Asia/Kolkata') as connect_time",
    'hangup_time': "date_trunc('second', COALESCE(callcenter_diallereventlog.hangup_time, callcenter_calldetail.hangup_time) at time zone 'Asia/Kolkata') as hangup_time",
    'wait_time': 'COALESCE(callcenter_diallereventlog.wait_time, callcenter_calldetail.wait_time) as wait_time',
    'ring_duration': 'COALESCE(callcenter_diallereventlog.ring_duration, callcenter_calldetail.ring_duration) as ring_duration',
    'hold_time': 'COALESCE(callcenter_diallereventlog.hold_time, callcenter_calldetail.hold_time) as hold_time',
    'callflow': 'callcenter_calldetail.callflow as callflow',
    'callmode': 'callcenter_calldetail.callmode as callmode',
    'bill_sec': 'COALESCE(callcenter_diallereventlog.bill_sec, callcenter_calldetail.bill_sec) as talk_time',
    'ivr_duration': 'COALESCE(callcenter_diallereventlog.ivr_duration, callcenter_calldetail.ivr_duration) as ivr_duration',
    'call_duration': 'COALESCE(callcenter_diallereventlog.call_duration, callcenter_calldetail.call_duration) as call_duration',
    'feedback_time': 'callcenter_calldetail.feedback_time as wrapup_time',
    'call_length': "cast(COALESCE(callcenter_diallereventlog.call_duration, callcenter_calldetail.call_duration)::interval + feedback_time::interval as text) as call_length",
    'hangup_source': 'callcenter_calldetail.hangup_source as hangup_source',
    'internal_tc_number': 'callcenter_calldetail.internal_tc_number as internal_tc_number',
    'external_tc_number': 'callcenter_calldetail.external_tc_number as external_tc_number',
    'progressive_time': 'callcenter_calldetail.progressive_time as progressive_time',
    ...
    'inbound_wait_time': 'callcenter_calldetail.inbound_wait_time as inbound_wait_time',
    'blended_wait_time': 'callcenter_calldetail.blended_wait_time as blended_wait_time',
    'hangup_cause': 'COALESCE(callcenter_diallereventlog.hangup_cause, callcenter_calldetail.hangup_cause) as hangup_cause',
    'hangup_cause_code': 'COALESCE(callcenter_diallereventlog.hangup_cause_code, callcenter_calldetail.hangup_cause_code) as hangup_cause_code',
    'dialed_status': 'COALESCE(callcenter_diallereventlog.dialed_status, callcenter_calldetail.dialed_status) as dialed_status',
    'comment': 'callcenter_cdrfeedbck.comment as comment',
    'primary_dispo': 'callcenter_cdrfeedbck.primary_dispo as primary_dispo',
    'sms_sent': "CASE WHEN sms.name IS NULL THEN 'No' ELSE 'Yes' END as sms_sent",
    'sms_message': 'sms.name as sms_message'
}
