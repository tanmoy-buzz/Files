...
def download_call_detail_report(filters, user, col_list, serializer_class, download_report_id=None):
	...
	"""	
	try:
		print(filters, user, col_list, 'downloaadreport')
		query = {}
		...
		print(calldetail,'CALLDETAIL WHERE')
		print('*'*50)
		print(callcenter_calldetail,'CALLDETAIL WHERE 1')
		print('^'*50)
		print(crm_contact,'CRM CONTACTTTTTTT')
